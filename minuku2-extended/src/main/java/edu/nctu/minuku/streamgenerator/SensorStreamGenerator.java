...
//        Log.d(TAG, "Sensor mAccele_str" + mAccele_str);
//        Log.d(TAG, "Sensor mGyroscope_str" + mGyroscope_str);
//        Log.d(TAG, "Sensor mGravity_str" + mGravity_str);
//        Log.d(TAG, "Sensor mLinearAcceleration_str" + mLinearAcceleration_str);
//        Log.d(TAG, "Sensor mRotationVector_str" + mRotationVector_str);
